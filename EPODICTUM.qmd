...
::: {.columns .cover-container}

::: {.column width="48%"}
![](images/cover.png){.cover-img}
:::
...
This book was written in *RStudio* using *Quarto*. The present html version is hosted with *GitHub Pages* on [EpoDicTum](https://github.com/...) and automatically updated after every commit. A print-ready PDF version will be available through *Amazon KDP*.
:::
