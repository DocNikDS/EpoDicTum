...
::: {.column width="4%"}
<!-- Spacer column for horizontal gap -->
:::
...
This book was written in *RStudio* using *Quarto*. The present html version is hosted with *GitHub Pages* on [EpoDicTum](https://docnikds.github.io/EpoDicTum/) and automatically updated after every commit. A print-ready PDF version will be available through *Amazon KDP*.
:::
...
The dictionary uses the word ***“tumor”*** in a deliberately broad historical-medical sense: not only malignant and benign neoplasms, but also non-neoplastic space-occupying lesions that have traditionally been called ***tumors***, such as *Pott puffy tumor*.
