...
In EpoDicTum, possessive case (i.e., *'s*) or nobiliary prefix particles in complex surnames (e.g., *de*, *d'*, *di*, *von*, *van*, etc.) are disregarded in both the entry headings and the alphabetical order of surnames in the Index of personalia. Thus, to locate a dictionary entry, one should search by the core surname itself (e.g., *ROKITANSKY*, not *VON ROKITANSKY*).
