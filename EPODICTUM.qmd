...
This book was written in *RStudio* using *Quarto* and *R*.  The present HTML version is hosted on *Posit Connect Cloud* at [EpoDicTum](https://docnikds-epodictum.share.connect.posit.cloud/) and is automatically updated after every commit. A print-ready PDF version will be available through *Amazon Kindle Direct Publishing*.
:::
